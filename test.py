...
def checkresultcount(out): 
	...
	with concurrent.futures.ThreadPoolExecutor() as executor2:
		t2=executor2.submit(db.db.execute_query_thread("select * from data"))
		res=t2.result()
...
def worst_case(out,rd,srd,a,b):
	...
	with concurrent.futures.ThreadPoolExecutor() as executor2:
		t2=executor2.submit(db.dict_to_table_thread,output,a)
        #res=t2.result()
	...
	#New function to write into database
	with concurrent.futures.ThreadPoolExecutor() as executor2:
		t2=executor2.submit(db.dict_to_table_thread,output2,localrecentdate)
